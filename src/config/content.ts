    ...
    segments: [
      {
        ...
        outcome: "Scale conversion and dominate SERP."
      },
      {
        id: "academic",
        icon: "GraduationCap",
        ...
        outcome: "Finish research with integrity & precision."
      },
      {
        id: "business",
        icon: "Briefcase",
        ...
        outcome: "Turn ideas into executive-ready assets."
      }
    ]
  },
  serviceClusters: [
    {
      ...
      packages: [
        { name: "Audit Sprint", timeline: "7 days", price: "Contact for Quote" },
        { name: "Growth Sprint", timeline: "30 days", price: "Contact for Quote" },
        { name: "Retainer Partnership", timeline: "3 months+", price: "Contact for Quote" }
      ]
    },
    {
      id: "academic",
      ...
      packages: [
        { name: "Thesis Repair Pack", timeline: "Varies", price: "Contact for Quote" },
        { name: "Data Analysis Pack", timeline: "3-5 days", price: "Contact for Quote" },
        { name: "Full Mentoring Program", timeline: "Semester-long", price: "Contact for Quote" }
      ]
    },
    {
      id: "business",
      ...
      packages: [
        { name: "Deck Sprint", timeline: "72h", price: "Contact for Quote" },
        { name: "SOP & Proposal Pack", timeline: "7 days", price: "Contact for Quote" },
        { name: "Monthly Executive Support", timeline: "Monthly", price: "Contact for Quote" }
      ]
    }
  ],
  experience: [
